...
class OutMails(models.Model):
    ...
    responsible_person = models.ForeignKey('accounts.DefUser', on_delete=models.SET_NULL,
                                           verbose_name='Исполнитель')
    status = models.ForeignKey('InOutMailsStatus', verbose_name='Статус', on_delete=models.SET_NULL, null=True, blank=True)
...
class CompaniesList(models.Model):
    ...
    contract_location = models.ForeignKey('ContractLocation', on_delete=models.SET_NULL,
...
class ContractRegistry(models.Model):
    ...
    company = models.ForeignKey('CompaniesList', on_delete=models.SET_NULL, verbose_name='Компания')
    ...
    consultion_date = models.DateField(auto_now_add=False, verbose_name='Дата заключения договора', null=True,
                                       blank=True)
    responsible_employee = models.ForeignKey('accounts.DefUser', on_delete=models.SET_NULL,
