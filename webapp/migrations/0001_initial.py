# Generated by Django 5.0.2 on 2024-03-29 12:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to='uploads/user_docs', verbose_name='Файлы')),
                ...
                ('task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='webapp.task', verbose_name='Задача')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
